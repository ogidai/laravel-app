      ...
      <main class="main">
        <div class="inner">
          <form class="post_form form" action="" method="post">
            @csrf
            <div class="card -form">
              <input type="hidden" name="id" class="-secondary" id="" value="aaa">
              ...
              <input type="text" name="how_to_buy" value="" class="-secondary @error('text') is-invalid @enderror" required placeholder="〇〇のECサイト" id="how_to_buy">
              @error('text')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
              ...
              <input type="text" name="how_to_drink" value="" class="-secondary @error('text') is-invalid @enderror" required placeholder="牛乳で飲むと美味しいです！" id="how_to_drink">
              @error('text')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
              ...
              <textarea type="text" name="comment" value=""class="textarea -secondary @error('text') is-invalid @enderror" required placeholder="このプロテインはすっきりとしていて、プロテインの独特な味がほとんどしないのでとてもおすすめです！プロテインは毎日飲むものですから、美味しいのが一番ですよね。是非お試しください！" id="comment"></textarea>
              @error('text')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
